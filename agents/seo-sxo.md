...
- Fetch the target URL using `seogeo render "<url>" --mode auto --json` (SPA-aware SSRF-protected renderer)
- Parse with `seogeo parse --url "<url>"` to extract SEO elements
...
- [ ] URL was fetched via seogeo render --mode auto (not raw curl)
