...
2. Use `seogeo render <URL> --mode auto --json` before HTML/source inspection so SPA content is visible when needed
...
seogeo pagespeed URL --json

# SPA-aware HTML/render inspection
seogeo render URL --mode auto --json
