...
- **Script:** `seogeo commoncrawl`
- **Cache:** `~/.cache/seo-geo-skill/commoncrawl/` (90-day TTL)
...
- **No auth needed:** Uses existing seogeo fetch + seogeo parse
- **Data:** Binary verification (link exists/lost/moved), anchor text, rel attributes
- **Script:** `seogeo verify-backlinks`
