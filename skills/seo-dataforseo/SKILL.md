...
```
seogeo dataforseo-costs check <endpoint> [--count N]
```
...
When DataForSEO MCP tools are available, other seo-geo-skill skills can leverage live data:
...
Match existing seo-geo-skill output patterns:
