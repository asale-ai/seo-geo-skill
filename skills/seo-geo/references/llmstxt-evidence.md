...
it as a Google ranking or citation lever in any seo-geo-skill report.
...
## How seo-geo-skill treats `llms.txt`
...
- If the user asks to generate one, seo-geo-skill produces a minimal valid
