...
Search ranking. Every seo-geo-skill audit that touches GEO should treat this doc
...
> seo-geo-skill's scores are heuristics, not Google-internal signals — state this
...
## How seo-geo-skill treats this guide
...
3. Where a third-party claim and Google contradict, seo-geo-skill defers to
