...
What the styling gives you: a cover page with the score badge, section
page breaks, severity-coloured callouts for headings containing
Critical/High/Medium/Low, and tables that survive A4 pagination.
